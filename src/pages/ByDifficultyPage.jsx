            ...
            <div className="flex flex-row pt-[110px]
                ...
                <div className="hidden 
                    ...
                    <div className="flex flex-col items-center 
                                    w-[200px] pt-[15px]">
                        <h1>Easy Champions</h1>
                        <p>0/0</p>
                    </div>

                    <div className="flex flex-col items-center 
                                    pt-[30px]">
                        <h1>Medium Champions</h1>
                        <p>0/0</p>
                    </div>

                    <div className="flex flex-col items-center 
                                    pt-[30px]">
                        <h1>Hard Champions</h1>
                        <p>0/0</p>
                    </div>               
                ...
                <div className="w-full flex flex-col items-center bg-gray-500
                    ...
                    <div className='w-full text-center p-10 bg-gray-600
                                    ...
                                    md:hidden
                                    sm:hidden'>
                        <h1 className="pb-5 text-xs">Easy Champions: 0/0</h1>
                        <h1 className="pb-5 text-xs">Medium Champions: 0/0</h1>
                        <h1 className="pb-5 text-xs">Hard Champions: 0/0</h1>
                    </div>
                    ...
                    <div className="w-full flex flex-row justify-around 
                        ...
                        <h1 className="font-bold hover:underline text-[10px]
                                        ...
                                        lg:text-base
                                        xl:text-base
                                        2xl:text-base">EASY</h1>
                        <h1 className="font-bold hover:underline text-[10px]
                                        sm:text-xs
                                        md:text-sm
                                        lg:text-base
                                        xl:text-base
                                        2xl:text-base">MEDIUM</h1>
                        <h1 className="font-bold hover:underline text-[10px]
                                        sm:text-xs
                                        md:text-sm
                                        lg:text-base
                                        xl:text-base
                                        2xl:text-base">HARD</h1>
                    </div>
                    </div>
